...
abstract class PubSubSpec implements TestPropertyProvider {
    ...
    static {
        ...
        try {
            ...
            // marketplace
            TopicName topicName = TopicName.of(props.trader.pubsub.project.name, props.trader.pubsub.topics.marketplace.name);
            topicClient.createTopic(topicName);
            SubscriptionName subscriptionName = SubscriptionName.of(props.trader.pubsub.project.name, props.trader.pubsub.topics.marketplace.listener);
